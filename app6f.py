#Works really well with different learning styles like socratic, questionaire etc incorporated in summary. Complete app. Needs extensive testing
...
options = ["None", "Summary", "Chatbot", "Exercise Help", "Quiz"]
...
if selected_chapter:
    ...
    if selected_option == "Summary":
        ...
        if selected_style:
            ...
            if os.path.exists(summary_path):
                ...
                st.write(f"### Summary ({selected_style} Style)")
    ...
    elif selected_option == "AR/VR":
        st.write("Display AR/VR content here.")
